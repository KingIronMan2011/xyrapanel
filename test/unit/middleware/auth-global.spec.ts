...
describe('auth.global middleware', () => {
  beforeEach(async () => {
    ...
    middleware = (await import('../../../server/middleware/auth.global.ts')).default as MiddlewareHandler
  })
  ...
  it('redirects to forced reset page when password reset required for page request', async () => {
    ...
    expect(mockSendRedirect).toHaveBeenCalledWith(event, '/auth/password/force?redirect=%2Faccount', 302)
  })
